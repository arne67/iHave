...
public class Constants {
    ...
    public static final String URL_AUTH_REDIRECT = "com.susarne.ihave2/oauth2redirect";
    ...
    private static final String URL_LOGOUT_REDIRECT = "com.susarne.ihave2:/logout";
